...
public class AnswerServiceTest {
    ...
    void createAnswer() throws Exception {
        ...
        answerService.createAnswer(question.getQuestionId(), answer, "test@nte");
    ...
    void updateAnswer() throws Exception {
        ...
        questionRepository.save(question);
        answerService.createAnswer(question.getQuestionId(), answer, "test@nte");
        answerService.updateAnswer(question.getQuestionId(), answer.getAnswerId(), updateAnswer, "test@nte");
